...
public class LaunchApplicationContextMain {
	...
	// mainメソッドを実行し、JavaベースConfiguration及びインジェクションの処理が行なわれていることを確認する
	public static void main(String[] args) {
		...
		System.out.println("JavaベースConfigurationについて確認する");
		System.out.println("Field Injectionの動作確認: FieldInjectionUserServiceImpl registerが実行され、UserRepositoryImpl saveが実行され、IFのListとMapがインジェクションされ、PasswordEncoderにSha256PasswordEncoderが用いられており、正常に動作していることが分かる");
