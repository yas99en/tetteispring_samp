...
// 8.3.3.2. トランザクション境界でのロールバック/コミットの制御 テストケースメソッド終了後にトランザクションをコミットする場合の指定例
...
class AccountRepositoryTest3 {
	...
	// 今度はトランザクションのコミットが効いているか確認するため、上のtestCreate()で登録したデータが残っていることを検証
	@Test
